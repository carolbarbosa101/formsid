...
<head>
    <title>Alterar Senha | PNAID</title>
            ...
            <div class="login col-md-12">
                <div class="row">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="alteracaosenha.php" style="text-align: center; margin-top: 100px;">
                            <div class="form-group">
                                <input type="password" name="novasenha" id="novasenha" class="form-control" placeholder="Digite a sua nova senha" required>
                            </div>

                            <div class="form-group">
                                <input type="password" name="confsenha" id="confsenha" class="form-control" placeholder="Confirme sua senha" required>
                            </div>
